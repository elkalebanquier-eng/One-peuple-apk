        ...
        <View style={[styles.sheet, { backgroundColor: colors.background, borderColor: colors.border }]}>
          ...
          <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
            <View style={[styles.lockedBanner, { backgroundColor: `${colors.warning}12`, borderColor: `${colors.warning}44` }]}>
              ...
              <Text style={[styles.lockedText, { color: colors.muted }]}>La compilation IPA est indisponible. Ce formulaire prépare seulement vos repères et ne débloque pas iOS.</Text>
            </View>
